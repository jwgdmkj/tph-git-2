import math #same
from copy import copy #same
from copy import copy #5-7
from pathlib import Path #same

import numpy as np #same
import pandas as pd #same
import requests #same
import torch #same
import torch.nn as nn #same
import torch.nn.functional as F #same
from torchvision.ops import DeformConv2d
from PIL import Image #same
from torch.cuda import amp #same

from utils.datasets import letterbox #half
from utils.general import non_max_suppression, make_divisible, scale_coords, increment_path, xyxy2xywh #half
from utils.plots import color_list, plot_one_box  #half
from utils.torch_utils import time_synchronized #same


##### basic ####

def autopad(k, p=None):  # kernel, padding   #same
    # Pad to 'same'
    if p is None:
